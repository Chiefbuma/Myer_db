                            ...
                            Section::make('Nutrition Assessment')
                                ->schema([
                                    ...
                                    TextInput::make('BMI')
                                        ...
                                        ->required()
                                        ->inlineLabel(), // This places the label on the side of the input
                                    TextInput::make('subcutaneous_fat')
                            ...
                            Section::make('Calls')
                                ->schema([
                                    Select::make('call_results')
                                        ->label('Call results')
                                        ->options(function () {
                                            return Call::pluck('call_results', 'call_id');
                                        })
                                        ->required(),
    ...
    public function saveNutrition(): void
    {
        ...
        DB::transaction(function () {
            Nutrition::create([
                ...
                'weight' => $this->weight,
                'BMI' => $this->BMI,
                'subcutaneous_fat' => $this->subcutaneous_fat,
